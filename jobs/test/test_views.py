...
class JobsViewTest(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        ...
        cls.tokenUserCandidate01 = Token.objects.create(user=cls.userCandidate01)
        cls.tokenUserCandidate02 = Token.objects.create(user=cls.userCandidate02)
    ...
    def test_create_job_only_authenticated_user_rh_sucess(self):
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserRH01.key)
    ...
    def test_create_job_not_user_rh_fail(self):
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserCandidate01.key)
    ...
    def test_patch_not_owner_company_rh_fail(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserRH02.key)

        res = self.client.patch('/api/companies/jobs/1/', {'title':'Não Alterado'})
    ...
    def test_subscribers_count_in_register_job(self):
        ...
        self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserCandidate02.key)
    ...
    # def test_desactive_job_is_owner_company_rh(self):
    #     self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserRH01.key)


    # def test_desactive_job_not_owner_company_rh(self):
    #     self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserRH01.key)
    #     self.client.credentials(HTTP_AUTHORIZATION="Token " + self.tokenUserRH02.key)