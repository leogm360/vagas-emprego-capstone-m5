...
class EducationViewTest(APITestCase):
    ...
    def setUpTestData(cls) -> None:
        print("\n\n Educations Views Tests \n")

        cls.userCandidate01 = Account.objects.create_user(
        ...
        cls.userNotCandidate01 = Account.objects.create_user(
        ...
        cls.education01 = {
            "institution_name": "Kenzie Academy",
            "course": "FullStack Web",
            "start_date": "2021-09-27",
            "end_date": "2022-09-27",
            "certificate_link": "https://google.com.br/image",
        }
    ...
    def test_create_education_only_authenticated_success(self):
        self.client.credentials(
            HTTP_AUTHORIZATION="Token " + self.tokenUser01.key
        )

        res = self.client.post(
            "/api/accounts/education/", data=self.education01
        )
    ...
    def test_create_education_not_candidate_fail(self):
        self.client.credentials(
            HTTP_AUTHORIZATION="Token " + self.tokenUser02.key
        )
        res = self.client.post(
            "/api/accounts/education/", data=self.education01
        )
    ...
    def test_patch_education_is_owner_success(self):
        ...
        res = self.client.patch(
            "/api/accounts/education/1/", data={"institution_name": "Alterado"}
        )
    ...
    def test_patch_education_not_is_owner_fail(self):
        ...
        res = self.client.patch(
            "/api/accounts/education/1/",
            data={"institution_name": "Não Alterado"},
        )
